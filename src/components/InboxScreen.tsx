      ...
      <main className="w-full max-w-2xl px-4 py-5 flex flex-col gap-5 flex-1 z-10">
        ...
        <div className="w-full p-4 rounded-2xl bg-[#0f121a]/90 border border-white/10 flex items-center justify-between shadow-md">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500/30 to-amber-700/30 border border-amber-500/40 flex items-center justify-center text-amber-300 font-bold text-lg shrink-0">
            ...
            <div className="min-w-0 pr-2">
              ...
              {currentUser.villageCity && (
                <span className="text-[11px] text-slate-400 flex items-center gap-1 mt-0.5 truncate">
                  ...
                  <span className="truncate">{currentUser.villageCity} ({currentUser.pinCode})</span>
                </span>
              )}
            </div>
          </div>
        ...
        {/* 3. Instagram-Style Username Search Bar */}
          ...
          <form onSubmit={handleSearchSubmit} className="relative w-full flex items-center gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                autoCapitalize="none"
                autoCorrect="off"
                className="w-full pl-10 pr-9 py-3 bg-[#161b26] border border-white/10 focus:border-amber-500/80 rounded-xl text-sm font-mono text-white placeholder:text-slate-500 focus:outline-none transition-all"
              />
              {searchQuery && (
                <button
                  type="button"
        ...
        {/* 4. Instagram Direct Message Inbox List */}
        <div className="w-full flex flex-col gap-2.5">
          ...
          {conversations.length > 0 ? (
              ...
              {conversations.map((conv) => (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    {/* Participant Avatar */}
                    <div className="w-11 h-11 rounded-xl bg-amber-500/15 border border-amber-500/25 flex items-center justify-center text-amber-300 font-bold text-base shrink-0 group-hover:scale-105 transition-transform">
            ...
            >
              ...
              <p className="text-xs text-slate-400 max-w-xs leading-relaxed">
                Search for another user by their registered username above to start an instant private 1-on-1 chat!
              </p>
            </div>
          )}
        </div>
